...
Disequilibrium provides the user functions to estimate, summarize, and produce predictions for the market in disequilibrium model as found in Gourieroux, C. (2000) <doi:10.1017/CBO9780511805608> and Maddala, G. (1983) <doi:10.1017/CBO9780511810176>.

The first study on a market in disequilibrium was Fair and Jaffee (1972) studying the supply and demand of housing starts. Soon followed many econometric refinements and extension. See Maddala and Nelson for correct Full Information Maximum Likelihood (FIML) estimators for four Disequilblirium models. This package currently supports estimating the first model. There are many other interesting papers about Disequilibrium models that are out of scope for this vignette . A few good summaries of the literature are Maddala (1983) and Gourieroux (2000). Calling these models "Disequilibrium" models is a bit of a misnomer, they might be better named "Non-market clearing" models (Citations). The specific model implemented in this package is not  implemented in any other package currently on CRAN to the best knowledge of the authors.However, there are other packages to implement similar models such as sampleSelection, censReg, AER, and MCMCpack. Call
